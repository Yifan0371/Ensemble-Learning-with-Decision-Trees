...
# GBRT DART Strong-scaling test: Fixed dataset size, measures execution time and MSE
...
for t in "${threads[@]}"; do
    ...
    # 6.2) Execute GBRT DART and capture full stdout
...
echo ""
echo "DART Specific Characteristics:"
echo "- Dropout operations add additional computational overhead."
echo "- Weight updates can become serial bottlenecks."
echo "- Inter-tree dependencies limit parallel effectiveness."
echo "- Expected efficiency slightly lower than standard GBRT (0.6-0.8)."
echo "==============================================="
